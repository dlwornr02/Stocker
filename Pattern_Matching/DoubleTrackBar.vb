...
<Designer(GetType(DoubleTrackBar.DoubleTrackBarDesigner))> _
...
#Region " Designer "
    ...
    Friend Class DoubleTrackBarDesigner
        Inherits ControlDesigner

        Private ReadOnly Property TrackBar As DoubleTrackBar
            Get
                Return DirectCast(Me.Control, DoubleTrackBar)
            End Get
        End Property

        Protected Overrides Function GetHitTest(ByVal point As System.Drawing.Point) As Boolean
            Dim pt = Me.TrackBar.PointToClient(point)
            If Me.TrackBar.GetLeftThumbRectangle().Contains(pt) _
            OrElse Me.TrackBar.GetRightThumbRectangle().Contains(pt) Then
                Return True
            End If
